...
function showItems(div_Productos) {  
    fetch('https://brisbiere-338c84ebe99a.herokuapp.com/brisbiere/api/products/' + localStorage.filtro, {
        mode: "no-cors",
        method: 'get',
        headers: {
...
async function loadBeers(){
    ...
    const request = await fetch('https://brisbiere-338c84ebe99a.herokuapp.com/brisbiere/api/products/available?sortDirection=' + localStorage.filtro,{
        method : 'GET',
        mode: "no-cors",
        headers: {
            'Accept': 'application/json',
